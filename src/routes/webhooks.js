 ...
 */
router.post('/customers/data_request', express.json(), (req, res) => {
 ...
 */
router.post('/shop/redact', express.json(), async (req, res) => {
 ...
 */
router.post('/app/uninstalled', express.json(), async (req, res) => {
  ...
  try {
    ...
    if (shopDomain) {
      // Mark shop as inactive or delete
      await pool.query(
